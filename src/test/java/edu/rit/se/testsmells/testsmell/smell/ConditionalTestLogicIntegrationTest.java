...
@IntegrationTest
public class ConditionalTestLogicIntegrationTest {
    ...
    @Test
    public void testConditionalTestLogic() throws IOException {

        TestFile file = new TestFile(
                "ConditionalTestLogicProject",
                "/ConditionalTestLogic/src/test/java/com/dalthed/tucan/EventsScraperTest.java",
                ""
        );
