...
@IntegrationTest
public class MagicNumberTestIntegrationTest {
    ...
    @Test
    public void testMagicNumberTest() throws IOException {
        TestFile file = new TestFile(
                "MagicNumberTestProject",
                "/MagicNumberTest/src/test/java/com/luckycatlabs/sunrisesunset/calculator/SolarEventCalculatorTest.java",
                ""
        );
        ...
        for (AbstractSmell testSmell : file.getTestSmells()) {
            if (testSmell != null) {
                if (testSmell.getSmellName().equals(new MagicNumberTest().getSmellName())) {
