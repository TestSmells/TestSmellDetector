...
@IntegrationTest
public class IgnoredTestIntegrationTest {
    ...
    public void testIgnoredTest() throws IOException {
        ...
        TestFile file = new TestFile(
                "IgnoredTestProject",
                // Obtained from https://projects.owldevelopers.site/cryptocoin/bitcoinj/blob/9e4d25b2c2f3cce791853eeea4b07ddc2a2d3cf2/core/src/test/java/org/bitcoinj/core/PeerGroupTest.java
                "/IgnoredTest/src/test/java/org/bitcoinj/core/PeerGroupTest.java",
                ""
        );
        ...
        for (AbstractSmell testSmell : file.getTestSmells()) {
            if (testSmell != null) {
                if (testSmell.getSmellName().equals(new IgnoredTest().getSmellName())) {
