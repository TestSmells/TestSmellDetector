...
@IntegrationTest
public class DuplicateAssertIntegrationTest {
    ...
    @Test
    public void testDuplicateAssert() throws IOException {
        ...
        for (AbstractSmell testSmell : file.getTestSmells()) {
            if (testSmell != null) {
                if (testSmell.getSmellName().equals(new DuplicateAssert().getSmellName())) {
