...
@IntegrationTest
public class RedundantAssertionIntegrationTest {
    ...
    @Test
    public void testRedundantAssertion() throws IOException {
        TestFile file = new TestFile(
                "RedundantAssertionProject",
                "/RedundantAssertion/src/androidTest/java/com/litmus/worldscope/LoginActivityTest.java",
                ""
        );
        ...
        for (AbstractSmell testSmell : file.getTestSmells()) {
            if (testSmell != null) {
                if (testSmell.getSmellName().equals(new RedundantAssertion().getSmellName())) {
