...
@IntegrationTest
public class ResourceOptimismIntegrationTest {
    ...
    @Test
    public void testResourceOptimism() throws IOException {

        TestFile file = new TestFile(
                "ResourceOptimismProject",
                "/ResourceOptimism/src/test/java/nodomain/freeyourgadget/gadgetbridge/test/LoggingTest.java",
                ""
        );
        ...
        for (AbstractSmell testSmell : file.getTestSmells()) {
            if (testSmell != null) {
                if (testSmell.getSmellName().equals(new ResourceOptimism().getSmellName())) {
